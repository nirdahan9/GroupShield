...
const strings = {
    ...
    'action_resume_auto': {
        he: '▶️ *השהיית האכיפה הסתיימה*\n\nהבוט חוזר לאכוף את החוקים בקבוצה *{{groupName}}*.',
        en: '▶️ *Enforcement pause ended*\n\nThe bot is now resuming enforcement in *{{groupName}}*.'
    },
